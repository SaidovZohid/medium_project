...
// Source: ../../genproto/user_service/auth_service_grpc.pb.go
...
import (
	...
	user_service "gitlab.com/medium-project/medium_api_gateway/genproto/user_service"
...
func (m *MockAuthServiceClient) ForgotPassword(ctx context.Context, in *user_service.ForgotPasswordRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthServiceClient) Login(ctx context.Context, in *user_service.LoginRequest, opts ...grpc.CallOption) (*user_service.AuthResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*user_service.AuthResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAuthServiceClient) Register(ctx context.Context, in *user_service.RegisterRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockAuthServiceClient) UpdatePassword(ctx context.Context, in *user_service.UpdatePasswordRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockAuthServiceClient) Verify(ctx context.Context, in *user_service.VerifyRequest, opts ...grpc.CallOption) (*user_service.AuthResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockAuthServiceClient) VerifyForgotPassword(ctx context.Context, in *user_service.VerifyRequest, opts ...grpc.CallOption) (*user_service.AuthResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockAuthServiceClient) VerifyToken(ctx context.Context, in *user_service.VerifyTokenRequest, opts ...grpc.CallOption) (*user_service.AuthPayload, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*user_service.AuthPayload)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// ForgotPassword mocks base method.
func (m *MockAuthServiceServer) ForgotPassword(arg0 context.Context, arg1 *user_service.ForgotPasswordRequest) (*empty.Empty, error) {
	m.ctrl.T.Helper()
...
// Login mocks base method.
func (m *MockAuthServiceServer) Login(arg0 context.Context, arg1 *user_service.LoginRequest) (*user_service.AuthResponse, error) {
	m.ctrl.T.Helper()
...
// Register mocks base method.
func (m *MockAuthServiceServer) Register(arg0 context.Context, arg1 *user_service.RegisterRequest) (*empty.Empty, error) {
	m.ctrl.T.Helper()
...
// UpdatePassword mocks base method.
func (m *MockAuthServiceServer) UpdatePassword(arg0 context.Context, arg1 *user_service.UpdatePasswordRequest) (*empty.Empty, error) {
	m.ctrl.T.Helper()
...
// Verify mocks base method.
func (m *MockAuthServiceServer) Verify(arg0 context.Context, arg1 *user_service.VerifyRequest) (*user_service.AuthResponse, error) {
	m.ctrl.T.Helper()
...
// VerifyForgotPassword mocks base method.
func (m *MockAuthServiceServer) VerifyForgotPassword(arg0 context.Context, arg1 *user_service.VerifyRequest) (*user_service.AuthResponse, error) {
	m.ctrl.T.Helper()
...
// VerifyToken mocks base method.
func (m *MockAuthServiceServer) VerifyToken(arg0 context.Context, arg1 *user_service.VerifyTokenRequest) (*user_service.AuthPayload, error) {
	m.ctrl.T.Helper()
