...
// Source: ../../genproto/user_service/user_service_grpc.pb.go
...
func (m *MockUserServiceClient) Create(ctx context.Context, in *user_service.User, opts ...grpc.CallOption) (*user_service.User, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*user_service.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserServiceClient) Delete(ctx context.Context, in *user_service.IdRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) Get(ctx context.Context, in *user_service.IdRequest, opts ...grpc.CallOption) (*user_service.User, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) GetAll(ctx context.Context, in *user_service.GetAllUsersRequest, opts ...grpc.CallOption) (*user_service.GetAllUsersResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*user_service.GetAllUsersResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserServiceClient) GetByEmail(ctx context.Context, in *user_service.GetByEmailRequest, opts ...grpc.CallOption) (*user_service.User, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) Update(ctx context.Context, in *user_service.User, opts ...grpc.CallOption) (*user_service.User, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// Create mocks base method.
func (m *MockUserServiceServer) Create(arg0 context.Context, arg1 *user_service.User) (*user_service.User, error) {
	m.ctrl.T.Helper()
...
// Delete mocks base method.
func (m *MockUserServiceServer) Delete(arg0 context.Context, arg1 *user_service.IdRequest) (*empty.Empty, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockUserServiceServer) Get(arg0 context.Context, arg1 *user_service.IdRequest) (*user_service.User, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockUserServiceServer) GetAll(arg0 context.Context, arg1 *user_service.GetAllUsersRequest) (*user_service.GetAllUsersResponse, error) {
	m.ctrl.T.Helper()
...
// GetByEmail mocks base method.
func (m *MockUserServiceServer) GetByEmail(arg0 context.Context, arg1 *user_service.GetByEmailRequest) (*user_service.User, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockUserServiceServer) Update(arg0 context.Context, arg1 *user_service.User) (*user_service.User, error) {
	m.ctrl.T.Helper()
