...
func (c *commentServiceClient) GetAll(ctx context.Context, in *GetAllCommentsParamsReq, opts ...grpc.CallOption) (*GetAllCommentsResponse, error) {
...
func _CommentService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllCommentsParamsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).GetAll(ctx, req.(*GetAllCommentsParamsReq))
	}
	return interceptor(ctx, in, info, handler)
}
