...
func (x *GetLikeRequest) GetPostId() int64 {
	if x != nil {
		return x.PostId
	}
	return 0
...
func (x *GetLikesRequest) GetPostId() int64 {
	if x != nil {
		return x.PostId
	}
	return 0
...
type LikesDislikesCountResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LikesDislikesCountResponse) Reset() {
	*x = LikesDislikesCountResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *LikesDislikesCountResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LikesDislikesCountResponse) ProtoMessage() {}

func (x *LikesDislikesCountResponse) ProtoReflect() protoreflect.Message {
	mi := &file_like_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LikesDislikesCountResponse.ProtoReflect.Descriptor instead.
func (*LikesDislikesCountResponse) Descriptor() ([]byte, []int) {
	return file_like_proto_rawDescGZIP(), []int{3}
}

func (x *LikesDislikesCountResponse) GetLikes() int64 {
	if x != nil {
		return x.Likes
	}
	return 0
...
func (x *LikesDislikesCountResponse) GetDislikes() int64 {
	if x != nil {
		return x.Dislikes
	}
	return 0
...
var file_like_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x42, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4c,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x22, 0x2a, 0x0a, 0x0f,
	...
	0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x22, 0x4e, 0x0a, 0x1a, 0x4c, 0x69, 0x6b, 0x65,
	0x73, 0x44, 0x69, 0x73, 0x6c, 0x69, 0x6b, 0x65, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6b, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6c, 0x69, 0x6b, 0x65, 0x73, 0x12, 0x1a, 0x0a, 0x08,
	0x64, 0x69, 0x73, 0x6c, 0x69, 0x6b, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08,
	0x64, 0x69, 0x73, 0x6c, 0x69, 0x6b, 0x65, 0x73, 0x42, 0x17, 0x5a, 0x15, 0x67, 0x65, 0x6e, 0x70,
...
func file_like_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_like_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LikesDislikesCountResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
