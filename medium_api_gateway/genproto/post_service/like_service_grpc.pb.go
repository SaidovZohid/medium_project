...
type LikeServiceClient interface {
	...
	GetLikesDislikesCount(ctx context.Context, in *GetLikesRequest, opts ...grpc.CallOption) (*LikesDislikesCountResponse, error)
}
...
func (c *likeServiceClient) GetLikesDislikesCount(ctx context.Context, in *GetLikesRequest, opts ...grpc.CallOption) (*LikesDislikesCountResponse, error) {
...
type LikeServiceServer interface {
	...
	GetLikesDislikesCount(context.Context, *GetLikesRequest) (*LikesDislikesCountResponse, error)
...
func (UnimplementedLikeServiceServer) GetLikesDislikesCount(context.Context, *GetLikesRequest) (*LikesDislikesCountResponse, error) {
...
func _LikeService_GetLikesDislikesCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LikeServiceServer).GetLikesDislikesCount(ctx, req.(*GetLikesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
