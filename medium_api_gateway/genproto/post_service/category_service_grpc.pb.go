...
type CategoryServiceClient interface {
	...
	Delete(ctx context.Context, in *GetCategoryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *categoryServiceClient) Delete(ctx context.Context, in *GetCategoryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type CategoryServiceServer interface {
	...
	Delete(context.Context, *GetCategoryRequest) (*emptypb.Empty, error)
...
func (UnimplementedCategoryServiceServer) Delete(context.Context, *GetCategoryRequest) (*emptypb.Empty, error) {
