...
type GetAllCategoryParamsReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAllCategoryParamsReq) Reset() {
	*x = GetAllCategoryParamsReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllCategoryParamsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllCategoryParamsReq) ProtoMessage() {}

func (x *GetAllCategoryParamsReq) ProtoReflect() protoreflect.Message {
	mi := &file_category_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllCategoryParamsReq.ProtoReflect.Descriptor instead.
func (*GetAllCategoryParamsReq) Descriptor() ([]byte, []int) {
	return file_category_proto_rawDescGZIP(), []int{2}
}

func (x *GetAllCategoryParamsReq) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *GetAllCategoryParamsReq) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *GetAllCategoryParamsReq) GetSearch() string {
	if x != nil {
		return x.Search
	}
	return ""
...
var file_category_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x71, 0x12, 0x14, 0x0a, 0x05,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x22, 0x62,
	...
	0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67,
	...
	0x6e, 0x74, 0x42, 0x17, 0x5a, 0x15, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70,
...
var file_category_proto_goTypes = []interface{}{
	...
	(*GetAllCategoryParamsReq)(nil), // 2: genproto.GetAllCategoryParamsReq
	(*GetAllCategoryResponse)(nil),  // 3: genproto.GetAllCategoryResponse
}
var file_category_proto_depIdxs = []int32{
	0, // 0: genproto.GetAllCategoryResponse.categories:type_name -> genproto.Category
...
func file_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_category_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllCategoryParamsReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
